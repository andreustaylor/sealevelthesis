...
Geophysists can define an a-periodic pole tide on the basis of the dynamic connection to gravitational body forces associated with astronomical motions.   And valid discussion of non-stationary tides \cite{Ray:2011tj}, quasi-periodic tidal phenomena \citep{Flinchem:2000kp} or storm tides \cite{Horsburgh:2008gw} in the literature and operational products each conceptually clash with the perspective of conventional harmonic analysis.  
