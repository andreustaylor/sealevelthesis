...
\begin{figure}[h]
    ...
    \caption{Ocean tide flow chart.}{Ocean tide flow chart (following Agnew \citep{agnew2015}.  Reference to the \ATGP{} is common to tidal analysis and prediction methods, whilst the treatment of tidal/non-tidal connections can differ markedly.}
