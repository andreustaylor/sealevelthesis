...
% Amp
\begin{figure}[!hbt] \centering
    \includegraphics[trim={0 0 0 1cm},clip,width=\figwidthFull]{figures/maps/locations_SaAmp.pdf} 
...
% Pha
\begin{figure}[!hbt] \centering
    \includegraphics[trim={0 0 0 1cm},clip,width=\\figwidthFull]{figures/maps/locations_SaPhaAnyM2Update.pdf} 
