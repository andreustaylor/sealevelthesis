...
\begin{figure}[!hbt] \centering
    ...
    \begin{subfigure}[b]{\figwidthThird}
        ...
        \caption{Timeseries scatter at \Fname{} comparing 1 year of hourly standard tide predictions to TPXO}
    \end{subfigure}
    \hfill{}
    \begin{subfigure}[b]{\figwidthThird}
...
There is of course a very long history of proposals for refinements or up-ending of tide prediction techniques \citep{Cartwright:2000tt}\citep{Jay:2003bj}, but in contrast the present argument is for an incremental shift in the thinking behind an established and valuable \textit{service}.
