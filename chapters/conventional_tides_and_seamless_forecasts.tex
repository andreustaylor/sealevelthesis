...
\begin{figure}[H]\centering
    ...
    \end{subfigure}
    \caption{Amplitude and phase of \textbf{Sa} at analysis locations}
    {Amplitude and phase of seasonal component \textbf{Sa} at locations with tidal analysis records.  Note Sa Doodson difference and initial phase \citep[10.4]{PCTMSL-sp9}}
    \label{fig:SaAmp}
\end{figure}   
