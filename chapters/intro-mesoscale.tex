...
\begin{figure}[h]\centering
  ...
  \caption{Schematic place of \OGCM{}s in terms of sub-grid-scale (SGS) parameterisations.}
...
\begin{figure}[h]\centering
  ...
  \caption{Spatial coverage of one satellite altimeter.}
          {Illustration of spatial coverage of satellite altimeter; single day of Saral in May 2020. Observations near the coast are excluded from assimilation.}
