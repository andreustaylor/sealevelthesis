...
% set a common width measure for figures
% ...usual 'textwidth' not behaving in this template
\newlength{\myfigwidth}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Sea Level Anomaly Forecasts on a Coastal Waveguide}
...
% map guidance
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{omaps_chart_anim_eg.png}
...
% coord system
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{ctw_coords.png}
...
% map waveguide
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{map_overview.png}
...
% coastline length 
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{mandelbrot_lengths.png}
...
% sla hovmuller
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{concat_sla_day0_full.png}
...
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{collate_g.png}
...
% 0 hours
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{concatC_U_gstr_lag_000.png}
...
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{concatC_sla_lag_066.png}
...
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{concatC_surgeg_lag_066.png}
...
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{interpTdiff_obs_sla_day0_d0.png}
    \caption{\CAPTIONc{} - Tide gauges versus OceanMAPS.}
    \label{fig:diff_tide_omaps}
\end{figure}
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{interpTdiff_obs_surgeg_day0_d0.png}
    \caption{\CAPTIONc{} - Tide gauges versus Surge.}
    \label{fig:diff_tide_surge}
\end{figure}
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{interpRdiff_sla_surgeg_day0.png}
...
% %----------------------------
% % shelf profiles
% \newcommand\CAPTIONd{Bathymetry discretisation profile: OceanMAPS(OFAM), Surge(ROMS) and Geoscience Australia(GA)}
% \begin{figure}[t]
%     \noindent\includegraphics[width=\myfigwidth]{qgis_shelf_profile0.png}
%     \caption[Bathymetery - east coast profile sample.]
%             {\CAPTIONd{} - east coast sample point}
%     \label{fig:profileE1}
% \end{figure}
% %----------------------------
%----------------------------
% shelf profiles
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{plot_skill_path_mebs.png}
