...
%=================================================================
\documentclass[jmse,article,accept,moreauthors,pdftex,10pt,a4paper]{mdpi} 
%--------------------
% Class Options:
%----------
% submit
...
\history{Received: 30 May 2017; Accepted: 25 July 2017; Published: date}
%------------------------------------------------------------------
...
\Author{\hl{Andy Taylor} $^{1,}$* and Gary B. Brassington $^{2}$ } 
%Please carefully check the accuracy of names and affiliations. Changes will not be possible after proofreading.

% Authors, for metadata in PDF
\AuthorNames{Andy Taylor, Gary B. Brassington}

% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{$^{1}$ \quad \hl{Bureau of Meteorology}, 700 Collins St Docklands 3008, Australia\\  %Please provide more specific affiliation, such as the department. 
$^{2}$ \quad \hl{Bureau of Meteorology}, 300 Elizabeth St Darlinghurst 1300, Australia; Gary.Brassington@bom.gov.au} 
...
\abstract{ A system for providing routine seven-day forecasts of sea level observable at tide gauge locations is described and evaluated.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \authorcontributions{Andy Taylor conceived, implemented and analyzed the system and also wrote this paper.  Gary B. Brassington lead the project and provided substantial critical input.}
%      \hl{For research articles with several authors, a short paragraph specifying their individual contributions must be provided. The following statements should be used ``X.X. and Y.Y. conceived and designed the experiments; X.X. performed the experiments; X.X. and Y.Y. analyzed the data; W.W. contributed reagents/materials/analysis tools; Y.Y. wrote the paper.'' Authorship must be limited to those who have contributed substantially to the work reported.}}
 %Please provide the author contributions to replace this part.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\conflictsofinterest{Both authors are employed by the Bureau of Meteorology, but declare no conflict of interest with regard to the results presented.  
The Bureau of Meteorology beyond the authors had no role in the design, analysis or presentation of the results}
%Please provide the conflict of interest to replace his part.
...
\noindent 
\begin{tabular}{@{}ll}
aggSL & Aggregate Sea Level\\
AHD & Australian Height Datum\\
ATGF & Astronomical Tide Producing Forces\\ 
BoM & Australian Bureau of Meteorology\\
HAT & Highest Astronomical Tide---conventional tidal plane\\
LAT & Lowest Astronomical Tide---conventional tidal plane\\
LIB & Local Inverse Barometer Approximation\\
MDT & Mean Dynamic Topography \\
MSL & Mean Sea Level---conventional tidal plane\\
MOM & Modular Ocean Model \\
NWP & Numerical Weather Prediction\\
OceanMAPS & Ocean Model, Analysis and Prediction System \\
...
%\input{aggSL_description_and_evaluation_v0.1.4.bbl}
