...
% map guidance
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{figures/maps/omaps_chart_anim_eg.png}
...
% coord system
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{figures/diagrams/ctw_coords.png}
...
% map waveguide
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{figures/maps/map_overview.png}
...
% coastline length 
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/mandelbrot_lengths.png}
...
% sla hovmuller
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/concat_sla_day0_full.png}
...
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/collate_g.png}
...
% 0 hours
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/concatC_U_gstr_lag_000.png}
...
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/concatC_sla_lag_066.png}
...
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/concatC_surgeg_lag_066.png}
...
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/interpTdiff_obs_sla_day0_d0.png}
    \caption{\CAPTIONc{} - Tide gauges versus OceanMAPS.}
    \label{fig:diff_tide_omaps}
\end{figure}
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/interpTdiff_obs_surgeg_day0_d0.png}
    \caption{\CAPTIONc{} - Tide gauges versus Surge.}
    \label{fig:diff_tide_surge}
\end{figure}
\begin{figure}
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/interpRdiff_sla_surgeg_day0.png}
...
% shelf profiles
\begin{figure}[t]
    \noindent\includegraphics[width=\myfigwidth]{figures/plots/plot_skill_path_mebs.png}
