...
\begin{figure}[!h]
	\centering
	%\subfloat{\includegraphics[width=50mm]{figures/HarrisFischer_tide_machine_ParkerFig1p1}}
	%\includegraphics[width=50mm]{figures/HarrisFischer_tide_machine_ParkerFig1p1}
	...
	\qquad
	%\subfloat{\includegraphics[width=50mm]{figures/DHI_machine_cartwright_fig11p2.png}}
    \includegraphics[width=50mm]{figures/DHI_machine_cartwright_fig11p2.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=100mm]{figures/diag_plot_014406_detide_compare_20120101.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=130mm]{figures/global_m2_tpx08.png}
...
\begin{figure}[h]
\begin{center}
\includegraphics[width=110mm]{figures/map_tide_differences_tpx_xovers.png}
